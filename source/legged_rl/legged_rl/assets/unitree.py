...
from legged_rl.assets import unitree_actuators

# Compute locally to avoid circular import (legged_rl.__init__ defines
# legged_rl_ROOT_DIR *after* `from .tasks import *`, so importing it from
# the package root during tasks initialisation causes a circular ImportError).
legged_rl_ROOT_DIR = _os.path.dirname(_os.path.dirname(_os.path.abspath(__file__)))
...
UNITREE_GO1_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{legged_rl_ROOT_DIR}/data/robots/go1_description/urdf/go1.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_GO2_CFG = UnitreeArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        fix_base=False,
        replace_cylinders_with_capsules=True,
        asset_path=f"{legged_rl_ROOT_DIR}/data/robots/go2_description/urdf/go2_description.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_G1_29DOF_CFG = UnitreeArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        fix_base=False,
        replace_cylinders_with_capsules=True,
        asset_path=f"{legged_rl_ROOT_DIR}/data/robots/g1_description/urdf/g1_29dof_rev_1_0.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
